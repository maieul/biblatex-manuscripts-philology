...
\newpage
\nocite{*}
\printshorthands[type=manuscript,title=Shorthands]
\printshorthands[type=manuscript,env=details,title=Shorthands with details]

\printbibliography[type=manuscript,title=Bibliography]
\printbibliography[type=manuscript,env=details,title=Bibliography with details]

\printshorthands[type=manuscript,env=details,title=Withoutshorts,check=withoutshorthand]

\printbibliography[type=manuscript,env=details,title=Withshorts,check=withshorthand]
