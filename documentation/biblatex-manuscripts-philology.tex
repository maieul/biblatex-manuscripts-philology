...
\verb+241+.  Do not prefix with “MS.”
\end{fieldlist}
...
“folio”) or ``pp.\ 88--99'' (“page”).  See the \biblatex manual for details.
...
With non-Gregorian calendars, enter the converted Gregorian date here, and the 
date in the original era in the \bibfield{annotation} field.
...
Use this field also for manuscript folio numbers.  E.g., “3\cs{verso}--5\cs{recto}.”
...
with or instead of \bibfield{annotation}. It starts a new section of the description 
