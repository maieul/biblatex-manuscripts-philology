...
\fielditem{shortcollection}{litteral} the abreviated form of the collection. Not used by the default style.
...
\fielditem{shorthand}{litteral} the shorthand of the manuscript. If this field is empty, the entry key will be used as shorthand, except if the option \opt{msnoauthoshorthand} is loaded. See \secref{opt:msnoauthoshorthand}.
...
\boolitem[false]{msnoauthoshorthand}\label{opt:msnoauthoshorthand}
...
\item Add \bibfield{shortcollection} field.
\item Add \opt{msnoauthoshorthand} option. 
\end{release}
