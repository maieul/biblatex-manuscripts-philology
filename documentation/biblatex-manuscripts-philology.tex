...
\fielditem{content}{literal} description of the manuscript's content, can be used instead of \bibfield{annotation}. If you want to add paragraphs inside it, you must use the \cs{par} command between each paragraph.
