...
\fielditem{support}{key or literal} the support of the manuscript, which will be translated in your work language. These keys are defined: \texttt{papyrus}, \texttt{paper}, \texttt{pergament}.
 To define your own key, see \secref{key-definition}.
\end{fieldlist}
